...
public class PlayerMovementGrappling : MonoBehaviour
{
    ...
    private void HandleFootsteps()
    {
        ...
        AudioClip clip = state == MovementState.sprinting ? sprintSound : walkSound;
        if (clip == null) return;
    ...
    bool HasNoInput()
    {
        return Mathf.Abs(Input.GetAxisRaw("Horizontal")) < 0.5f && Mathf.Abs(Input.GetAxisRaw("Vertical")) < 0.5f;
    }
